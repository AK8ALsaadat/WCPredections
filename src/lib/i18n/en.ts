...
export const en = {
  ...
  tutorial: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Double your match score points — once per knockout round, with bet combos available from the quarter-finals.",
      ...
      },
      {
        ...
        example: "Salem — scores +5, doesn't score −5",
        points: "+5 or −5",
  ...
  auth: {
    ...
    boldFiveNoticeTitle: "Bold bet points update",
    boldFiveNoticeBody: "From now on, your bold bet earns +5 points if the player scores and loses 5 points if they do not.",
    boldFiveNoticeRound: "The bold bet is available once per round.",
    boldFiveNoticeContinue: "Got it",
  },
  sponsor: {
  ...
  pointsBreakdown: {
    ...
    boldScorerWin: (name: string) => `Bet: ${name} scored`,
    boldScorerMiss: (name: string) => `Bet: ${name} didn't score`,
    boldScorerDetail: "Once per round — ±5 points",
    perfectBonus: "🎯 Perfect prediction — all details correct",
    perfectBonusDetail: "Bonus on top of exact score, scorers, and finish type",
    pendingScore: "Score prediction",
    pendingScoreDetail: (predH: number, predA: number) =>
      `Predicted ${predH}-${predA}`,
    pendingScorer: (name: string) => `Predicted scorer: ${name}`,
    pendingBold: (name: string) => `Bet: ${name}`,
  ...
  predict: {
    ...
    doubleHint: "The double limit follows the current round",
    ...
    doubleExhausted: "You used all doubles available this round",
    doubleOnThisMatch: "Active on this match",
    doubleLocked: "Double is active — can't turn off after saving",
    doubleAndBoldConflict: "Can't use double and the bet on the same match",
    boldLocked: "The bet is locked — can't remove or change player",
    boldCounter: (used: number, max: number) =>
      `Bet: ${used}/${max}`,
    boldAvailable: "Available — pick one player",
    boldUsedHere: (name: string) => `Used this match: ${name}`,
    boldExhausted: "You used your bet on another match this round",
    ...
    boldScorerBet: {
      ...
      choosePlayerRequired: "Pick a player for the bet",
      selectedWithCheck: (name: string) => `✓ ${name}`,
      clearSelection: "Remove player",
      selected: (name: string) => `Your bet: ${name}`,
      usedElsewhere:
        "You used your bet on another match this round — once only",
  ...
  leaderboard: {
    ...
    leaderTag: "Leader",
    relegated: "Relegated",
    administrationExemption: "Management exemption",
    username: "Predictor",
    points: "Points",
